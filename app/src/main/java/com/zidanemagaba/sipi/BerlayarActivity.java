...
public class BerlayarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_berlayar);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(status.equals("1")){
                    ...
                    builder.setMessage("Apakah semua data dan persiapan lengkap?");
                    ...
                    builder.setPositiveButton("Mulai Berlayar", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int j) {


                            StringRequest stringrequest = new StringRequest(Request.Method.POST, Server.SEND_BERLAYAR,
                                    new Response.Listener<String>() {
                                        @Override
                                        public void onResponse(String response) {

                                            AlertDialog.Builder send = new AlertDialog.Builder(BerlayarActivity.this);
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(BerlayarActivity.this, "EROR :" + error, Toast.LENGTH_SHORT).show();
                            ...
                            AppController.getInstance(BerlayarActivity.this).addTorequestque(stringrequest);
                    ...
                    builder.setTitle("Perhatian");
                    builder.setMessage("Kapal belum berlabuh");
                    builder.setCancelable(false);
                    ...
                    builder.setTitle("Perhatian");
                    builder.setMessage("Tidak dapat dilanjutkan karena SIPI tidak aktif");
                    builder.setCancelable(false);
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int j) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            Toast.makeText(BerlayarActivity.this, "Eror "+e, Toast.LENGTH_LONG).show();
                        }
                    }
                },
        ...
        try {
            ...
            if(!(result.equals("null"))){
                ...
                if(status.equals("1")){
                    ...
                    t_status.setText("Kartu Terblokir");
                }else if(status.equals("4")){
                ...
                Toast.makeText(BerlayarActivity.this,"Data tidak tersedia",Toast.LENGTH_SHORT).show();
                finish();
            }
